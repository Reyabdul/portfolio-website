...
export const Header = () => {
  ...
  return (
    <>
      <nav className="h-auto w-screen fixed flex  items-center justify-between p-4 bg-transparent z-10">
        <div className="flex">
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            ...
            <div className=" w-screen h-screen flex max-md:flex-col-reverse items-center text-white text-xl p-10">
              <div className="w-1/2 max-md:w-full max-md:h-1/2 flex flex-col ">
                <div className="py-2 border-b-1">
                  <h2 className="text-[2rem] max-md:text-[1.2rem] font-bold">
                    {menuData.heading}
                  </h2>
                ...
                <div className="py-2 border-b-1">
                  ...
                  <p className="text-xs">{menuData.email}</p>
                </div>
                <div className="py-2">
                  <h3 className="font-bold max-md:text-[1rem]">
                    {menuData.subHeading2}:
                  </h3>
                  <p className="text-xs">filler | filler | filler</p>
                </div>
              </div>
